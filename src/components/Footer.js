...
const Footer = () => {
  return (
    <footer className="text-center mb-5 mt-3">
      <div className="container mx-auto flex justify-center items-center gap-4">
        <p>Copyright ©2024 devzkund | All rights reserved.</p>
        <a
          className="text-muted-foreground hover:text-foreground transition-colors"
          href="https://www.instagram.com/devzkund?igsh=Z3g1ZnV5Z2RjeDBx"
        >
          <svg
        ...
        <a
          className="text-muted-foreground hover:text-foreground transition-colors"
          href="https://www.linkedin.com/in/devzkund"
          rel="ugc"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
        ...
        <a
          className="text-muted-foreground hover:text-foreground transition-colors"
          href="https://github.com/DevZkund?tab=repositories"
          rel="ugc"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
